...
def to_full_training_zarr(gcs_base_dir: str, gcs_output_zarr: str, n_zarr: int = None) -> None:
    ...
    for var in TENDENCY_VARS:
        big_ds[f"d{var}_dt"] = compute_tendency(big_ds[var], t_dim = 'initialization_time')
