...
fig, axs = plt.subplots(len(variables_3d), len(model.output_variables), figsize=(12,12))
...
fig, axs = plt.subplots(len(variables_2d), len(model.output_variables), figsize=(12,12))
