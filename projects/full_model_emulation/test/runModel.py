...
model = GraphWeatherForecaster(lat_lons,resolution=2, feature_dim=7, output_dim=2, node_dim=64, num_blocks=6,hidden_dim_processor_node=64,hidden_dim_processor_edge=64,hidden_layers_processor_node=2,hidden_layers_processor_edge=2,hidden_dim_decoder=64,hidden_layers_decoder=2,norm_type="LayerNorm").to(device)
...
for epoch in range(1, epochs + 1):
    ...
    for ss in all_indices:
        ...
        scheduler.step()
        val_loss = evaluate_model11(model, loss, val_iter, exteraVar, out_feat, device)
