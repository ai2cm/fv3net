...
class UnetGraphSAGE(nn.Module):
    def __init__(self, g, in_feats, h_feats, out_feat, num_step, aggregat):
        ...
        self.conv1 = GATConv(in_feats, int(h_feats / 16), aggregat)
        self.conv2 = GATConv(int(h_feats / 16), int(h_feats / 16), aggregat)
        self.conv3 = GATConv(int(h_feats / 16), int(h_feats / 8), aggregat)
        self.conv4 = GATConv(int(h_feats / 8), int(h_feats / 4), aggregat)
        self.conv5 = GATConv(int(h_feats / 4), int(h_feats / 2), aggregat)
        self.conv6 = GATConv(int(h_feats / 2), int(h_feats), aggregat)
        self.conv7 = GATConv(int(h_feats), int(h_feats), aggregat)
        self.conv8 = GATConv(int(h_feats), int(h_feats / 2), aggregat)
        self.conv9 = GATConv(int(h_feats / 2), int(h_feats / 4), aggregat)
        self.conv10 = GATConv(int(h_feats / 4), int(h_feats / 8), aggregat)
        self.conv11 = GATConv(int(h_feats / 8), int(h_feats / 16), aggregat)
        self.conv12 = GATConv(int(h_feats / 16), out_feat, aggregat)
        self.g = g
