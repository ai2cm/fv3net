...
class Decoder(torch.nn.Module):
    ...
    def forward(self, start_features: torch.Tensor, processor_features: torch.Tensor, batch_size: int) -> torch.Tensor:
        """
        Adds features to the encoding graph
        Args:
            start_features: Input node features in shape [B*Nodes, Features]
        ...
        # Read nodes to match graph node number
        ...
        out = out+ start_features[:,:,0:out.shape[2]]   # residual connection
        return out