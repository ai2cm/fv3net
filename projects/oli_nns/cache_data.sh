...
python -m loaders.batches.save train.yaml cached_train --variable-names $variable_names
python -m loaders.batches.save validation.yaml cached_validation --variable-names $variable_names
