...
def get_env(args):
    ...
    env["OUTPUT_FREQ_SEC"] = str(args.output_frequency)
    env["SAVE_ZARR"] = "True"
    return env
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-frequency", type=int, default=10800)
    parser.add_argument(
        "--model",
        type=str,
    ...
    parser.add_argument(
        ...
        default="",
        help="A unique tag. "
        "Can be used to look-up these outputs in subsequent timesteps.",
    )
    parser.add_argument(
        "--segments", "-n", type=int, default=1, help="number of segments"
    )
