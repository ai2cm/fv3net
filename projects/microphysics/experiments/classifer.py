...
def _get_job():
    config = load_yaml(f"../train/gscond-classifier.yaml")
    # Training loss problems are visible after 5 epochs
    config["epochs"] = 50
    return TrainingJob(
        name=f"gscond-classifier-v1", fv3fit_image_tag=revision, config=config,
    )


revision = "1a2610a55a889855f5c1f93028f83cf08c1d2bf7"
