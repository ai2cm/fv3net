...
def train_graph_model(
    ...
    get_Xy = curry(get_Xy_dataset)(
        input_variables=hyperparameters.input_variables, output_variables=hyperparameters.output_variables, n_dims=3,
    )
    ...
    hyperparameters.training_loop.fit_loop(hyperparameters,
...
def stepwise_loss(
    config: GraphHyperparameters, train_model, inputs, labels
):
