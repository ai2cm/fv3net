...
def test_open_fine_resolution_nudging_hybrid_clouds_off_with_nudging(
    ...
    data = open_fine_resolution_nudging_hybrid_clouds_off_with_nudging(
        None,
        {"url": nudging_url, "open_merged_nudged_kwargs": open_merged_nudged_kwargs},
        {"fine_res_url": fine_url},
    )
...
def test_open_fine_resolution_nudging_hybrid_clouds_off_with_xshield_nudging(
    nudging_url, fine_url
):
    open_merged_nudged_kwargs = {
        "merge_files": (
    ...
    data = open_fine_resolution_nudging_hybrid_clouds_off_with_xshield_nudging(
        None,
        {"url": nudging_url, "open_merged_nudged_kwargs": open_merged_nudged_kwargs},
        {"fine_res_url": fine_url},
    )
