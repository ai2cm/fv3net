...
These are python Mappings whose keys correspond to timesteps, and whose values are the data at
the keyed timestep.
...
Batches
-------------------------------
A "batch" in the fv3net sense is a dataset that is used in one loop iteration of either a training loop org
...
The following functions are create sequences of batches.
