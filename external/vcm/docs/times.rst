...
------------------------------
   ...
   .. autofunction:: vcm.convenience.parse_timestep_str_from_path
   .. autofunction:: vcm.convenience.shift_timestamp
   .. autofunction:: vcm.convenience.encode_time

Rounding times
--------------

   .. autofunction:: vcm.convenience.round_time