...
grid384 = diags[["grid_lat_coarse", "grid_latt_coarse", "grid_lon_coarse", "grid_lont_coarse", "area_coarse"]]
...
# coarsen the data
diags48 = coarsen.weighted_block_average(diags384, diags384["area_coarse"], x_dim = "grid_xt", y_dim = "grid_yt", coarsening_factor=8)
