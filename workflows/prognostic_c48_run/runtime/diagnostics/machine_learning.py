...
def compute_ml_diagnostics(
    state: State, ml_tendency: State, heating_key="dQ1", moistening_key="dQ2"
) -> Diagnostics:
...
def compute_ml_momentum_diagnostics(
    state: State, tendency: State, eastwind_key="dQu", northwind_key="dQv"
) -> Diagnostics:
    delp = state[DELP]
