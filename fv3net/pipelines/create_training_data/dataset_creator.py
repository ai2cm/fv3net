...
def write_to_zarr(
    ds, gcs_dest_dir, zarr_filename, bucket="vcm-ml-data",
):
...
def create_training_dataset(data_urls, mask_to_surface_type=None, project="vcm-ml"):
    """
    ...
    logger.info(
        f"Finished loading zarrs for timesteps "
