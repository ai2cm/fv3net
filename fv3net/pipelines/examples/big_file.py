...
def run(beam_options):
    ...
    big_file = "gs://vcm-ml-data/2019-10-03-X-SHiELD-C3072-to-C384-diagnostics/gfsphysics_15min_fine.tile1.nc.0000"
    with beam.Pipeline(options=beam_options) as p:
        (p | beam.Create([big_file])
         | 'ConvertToZarr' >> beam.ParDo(download_big)
         )
