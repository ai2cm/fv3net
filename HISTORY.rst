...
* add __main__.py to fv3net/regression/sklearn, which isolates training the ML model to its own module
* Because of above change, prognostic run no longer depends on vcm, and its requirements.txt is much shorter
