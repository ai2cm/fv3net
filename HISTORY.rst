...
* Sea ice is counted as sea when doing domain averaging in diagnostics (so a grid cell is always counted the same surface type domain regardless of season)
